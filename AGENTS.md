# AGENTS.md — pharmacy-app KMP companion

Project-scoped instructions for Codex in
...
- **Skills** (`.Codex/skills/`) — reach for these before hand-rolling:
...
See repo-root `AGENTS.md` at `/Users/admin/ProjectPos/AGENTS.md` for
