...
class ProfitQuickPeriodTest {
    ...
    fun today_resolves_to_a_single_day_window() {
        val range = ProfitQuickPeriod.Today.resolve()
    ...
    fun this_week_starts_no_later_than_today() {
        val range = ProfitQuickPeriod.ThisWeek.resolve()
    ...
    fun this_month_starts_no_later_than_today() {
        val range = ProfitQuickPeriod.ThisMonth.resolve()
    ...
    fun last_month_ends_before_this_month_starts() {
        val lastMonth = ProfitQuickPeriod.LastMonth.resolve()
        val thisMonth = ProfitQuickPeriod.ThisMonth.resolve()
        assertTrue(
    ...
    fun last_month_spans_at_least_28_days_and_at_most_31() {
        val range = ProfitQuickPeriod.LastMonth.resolve()
