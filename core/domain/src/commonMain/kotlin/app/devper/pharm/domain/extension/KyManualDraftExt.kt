...
fun buildKy10Draft(
    ...
    validateKyManualCommon(date = date, drugName = drugName, unit = unit, qty = qty)
...
private fun validateKyManualCommon(date: String, drugName: String, unit: String, qty: String) {
