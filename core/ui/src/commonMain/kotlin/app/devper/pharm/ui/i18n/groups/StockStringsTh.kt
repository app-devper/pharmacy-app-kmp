...
object StockStringsTh : StockStrings {
    ...
    override val stockPricingTitle = "ราคาตามกลุ่มลูกค้า"
    override val stockPricingSubtitle = "เว้นว่างเพื่อใช้ราคาขายปกติ"
    override val stockAltUnitsTitle = "หน่วยขายเพิ่มเติม"
    override val stockAltUnitsSubtitle = "เพิ่มหน่วยบรรจุ เช่น แผงหรือกล่อง พร้อมจำนวนหน่วยหลักต่อหน่วยขาย"
    override val stockAltUnitAdd = "เพิ่มหน่วยขาย"
    override val stockAltUnitEmpty = "ยังไม่มีหน่วยขายเพิ่มเติม"
    override val stockAltUnitTitle: (Int) -> String = { index -> "หน่วยขาย $index" }
    override val stockAltUnitName = "ชื่อหน่วย"
    override val stockAltUnitFactor = "จำนวนหน่วยหลัก"
    override val stockAltUnitFactorHint = "อย่างน้อย 2"
    override val stockAltUnitHidden = "ซ่อนหน่วยนี้จากหน้าขาย"
    override val stockAltUnitNameDuplicate = "ชื่อหน่วยซ้ำกับรายการอื่น"
    override val stockAltUnitNameMatchesBase = "ชื่อหน่วยต้องต่างจากหน่วยหลัก"
    override val stockAltUnitFactorInvalid = "จำนวนหน่วยหลักต้องอย่างน้อย 2"
    override val stockLoadFailed = "โหลดข้อมูลสต็อกไม่สำเร็จ"
    ...
    override val stockDrugFormLoadFailed = "โหลดข้อมูลยาไม่สำเร็จ"
    override val stockDrugFormLotExpiryInvalid = "วันหมดอายุของล็อตเริ่มต้นไม่ถูกต้อง (รูปแบบ YYYY-MM-DD)"
}
