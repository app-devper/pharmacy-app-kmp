...
internal val DarkPharmColors = LightPharmColors.copy(
    ...
    accent             = Blue500,
    accentHover        = Blue400,
    accentBgSoft       = Color(0x263B82F6),
    focusRing          = Blue500,
    successBg          = Color(0x2610B981), successFg = Green400,
    warningBg          = Color(0x26F59E0B), warningFg = Amber400,
    dangerBg           = Color(0x26EF4444),  dangerFg  = Red300,
    infoBg             = Color(0x263B82F6),  infoFg    = Blue400,
    price              = Blue400,
    discount           = Rose400,
    typePurpleBg       = Color(0x269333EA), typePurpleFg = Purple200,
    typeEmeraldBg      = Color(0x2610B981), typeEmeraldFg = Green300,
    typeOrangeBg       = Color(0x26EA580C), typeOrangeFg = Orange300,
    ky9Bg              = Color(0x263B82F6), ky9Fg = Blue400, ky9Border = Color(0x4D3B82F6),
    ky10Bg             = Color(0x269333EA), ky10Fg = Purple200, ky10Border = Color(0x4D9333EA),
    ky11Bg             = Color(0x26EF4444), ky11Fg = Red300, ky11Border = Color(0x4DEF4444),
    ky12Bg             = Color(0x260D9488), ky12Fg = Teal200, ky12Border = Color(0x4D0D9488),
    indigoBg           = Color(0x266366F1), indigoFg = Indigo300,
)
