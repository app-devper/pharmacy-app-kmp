...
class PharmStringsTablesTest {
    ...
    fun th_and_en_tables_differ_on_every_localised_key() {
        ...
        check("settingsDisplayTheme", PharmStringsTh.settingsDisplayTheme, PharmStringsEn.settingsDisplayTheme, mismatches)
        check("settingsThemeLight", PharmStringsTh.settingsThemeLight, PharmStringsEn.settingsThemeLight, mismatches)
        check("settingsFontMd", PharmStringsTh.settingsFontMd, PharmStringsEn.settingsFontMd, mismatches)
        check("settingsDensityComfortable", PharmStringsTh.settingsDensityComfortable, PharmStringsEn.settingsDensityComfortable, mismatches)
        ...
        check("suppliersSubtitle", PharmStringsTh.suppliersSubtitle, PharmStringsEn.suppliersSubtitle, mismatches)
